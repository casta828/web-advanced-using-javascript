window.onload = function () {
    ...
    modalFront.textContent = 'pacha = earth';
    body.appendChild(modalFront);

    //popup modal
    var modalTextButton = document.getElementsByTagName('li')[12];
    function showModal(){
    ...
    var menuTextButton = document.getElementsByTagName('li')[11];

    menuTextButton.onclick = function (){
        if (myMenu.style.visibility !== 'visible'){
            menuTextButton.innerHTML = 'DISCOVER';
            menuTextButton.style.color = 'white';
            menuTextButton.style.fontWeight = 'bold';
